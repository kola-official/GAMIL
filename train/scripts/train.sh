...
SOURCE_FASTA="${SOURCE_FASTA:-${PROCESSED_DATA_ROOT}/realm_rank/train.fasta.gz}"
SOURCE_DEV_FASTA="${SOURCE_DEV_FASTA:-}"
DATASET_DIR="${DATASET_DIR:-${PROCESSED_DATA_ROOT}/realm_rank}"
...
if [[ "${SMOKE_TEST}" == "1" ]]; then
  DATA_OUT="${DATA_OUT:-${PROCESSED_DATA_ROOT}/realm_rank/train_csv_smoke}"
  ...
  DATA_OUT="${DATA_OUT:-${PROCESSED_DATA_ROOT}/realm_rank/train_csv}"
