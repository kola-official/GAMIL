#!/usr/bin/env python3
"""Benchmark six trained models plus two frozen teachers on Realm-Rank test."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark Realm-Rank six-model experiment")
...
def model_spec(model_name: str, model_root: Path) -> Tuple[str, Path]:
    ...
    if model_name == "viralm_r":
        return "meanpool", Path(TEACHER_MODELS["viralm_r"])
