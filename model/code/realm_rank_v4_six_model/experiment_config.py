#!/usr/bin/env python3
"""Path and model-name defaults for the Realm-Rank v4 six-model experiment."""
...
DATA_ROOT = PROCESSED_DATA_ROOT / "realm_rank_v4"
...
OUTPUT_ROOT = Path(os.environ.get("OUTPUT_ROOT", CHECKPOINT_ROOT / "realm_rank_v4_six_model")).resolve()
...
TEACHER_MODELS = {
    ...
    "viralm_r_v4_final": STAGED_ROOT / "viralm-r",
}

SIX_LAYER_INIT_MODELS = {
    "viralm_o": INIT_ROOT / "viralm_o_6l",
    "viralm_r_v4_final": INIT_ROOT / "viralm_r_v4_final_6l",
}
...
TRAINING_TASKS = [
    ...
    {
        "name": "viralm_r_v4_final_6l_meanpool_kd",
        "entry": "train_meanpool_kd.py",
        "student": SIX_LAYER_INIT_MODELS["viralm_r_v4_final"],
        "teacher": TEACHER_MODELS["viralm_r_v4_final"],
        "kind": "meanpool_kd",
    },
    {
    ...
    {
        "name": "viralm_r_v4_final_6l_gated_mil_kd",
        "entry": "train_gated_mil_kd.py",
        "student": SIX_LAYER_INIT_MODELS["viralm_r_v4_final"],
        "teacher": TEACHER_MODELS["viralm_r_v4_final"],
        "kind": "gated_mil_kd",
    ...
    {
        "name": "viralm_r_v4_final_12l_gated_mil",
        "entry": "train_gated_mil_supervised.py",
        "student": TEACHER_MODELS["viralm_r_v4_final"],
        "teacher": None,
        "kind": "gated_mil_supervised",
    },
]
...
EUK_PRO_REFERENCE_FILES = {
    ...
    "sequence_o_vs_r_v4_comparison.csv": "euk_pro_sequence_o_vs_r_v4_comparison.csv",
