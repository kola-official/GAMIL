#!/usr/bin/env python3
"""Benchmark six trained models on the Realm-Rank euk/pro v4 FASTA suite."""
...
DEFAULT_DATA_ROOT = PROCESSED_DATA_ROOT / "realm_rank_test_v4"
DEFAULT_OUTPUT_DIR = OUTPUT_ROOT / "benchmark_euk_pro_v4"
DEFAULT_MODELS = [
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark six trained models on Realm-Rank euk/pro v4 FASTAs")
...
def main() -> None:
    args = parse_args()
    if Path(args.data_root).name != "realm_rank_test_v4":
        raise SystemExit(f"refusing non-v4 data root: {args.data_root}")
